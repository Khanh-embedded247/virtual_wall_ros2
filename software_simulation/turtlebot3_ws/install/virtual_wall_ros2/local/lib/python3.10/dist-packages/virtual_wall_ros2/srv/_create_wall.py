...
class Metaclass_CreateWall(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'virtual_wall_ros2.srv.CreateWall')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from virtual_wall_ros2.srv import _create_wall
...
class CreateWall(metaclass=Metaclass_CreateWall):
    from virtual_wall_ros2.srv._create_wall import CreateWall_Request as Request
    from virtual_wall_ros2.srv._create_wall import CreateWall_Response as Response
