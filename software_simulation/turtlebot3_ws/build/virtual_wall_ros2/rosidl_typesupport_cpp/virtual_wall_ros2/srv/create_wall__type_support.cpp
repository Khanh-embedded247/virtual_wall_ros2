...
static const _CreateWall_Request_type_support_symbol_names_t _CreateWall_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, virtual_wall_ros2, srv, CreateWall_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, virtual_wall_ros2, srv, CreateWall_Request)),
  }
};
...
{
  return &::virtual_wall_ros2::srv::rosidl_typesupport_cpp::CreateWall_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, virtual_wall_ros2, srv, CreateWall_Request)() {
  return get_message_type_support_handle<virtual_wall_ros2::srv::CreateWall_Request>();
}
...
static const _CreateWall_Response_type_support_symbol_names_t _CreateWall_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, virtual_wall_ros2, srv, CreateWall_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, virtual_wall_ros2, srv, CreateWall_Response)),
  }
};
...
{
  return &::virtual_wall_ros2::srv::rosidl_typesupport_cpp::CreateWall_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, virtual_wall_ros2, srv, CreateWall_Response)() {
  return get_message_type_support_handle<virtual_wall_ros2::srv::CreateWall_Response>();
}
...
static const _CreateWall_type_support_symbol_names_t _CreateWall_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, virtual_wall_ros2, srv, CreateWall)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, virtual_wall_ros2, srv, CreateWall)),
  }
};
...
{
  return &::virtual_wall_ros2::srv::rosidl_typesupport_cpp::CreateWall_service_type_support_handle;
}
