...
static const _DeleteWall_Request_type_support_symbol_names_t _DeleteWall_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, virtual_wall_ros2, srv, DeleteWall_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, virtual_wall_ros2, srv, DeleteWall_Request)),
  }
};
...
{
  return &::virtual_wall_ros2::srv::rosidl_typesupport_cpp::DeleteWall_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, virtual_wall_ros2, srv, DeleteWall_Request)() {
  return get_message_type_support_handle<virtual_wall_ros2::srv::DeleteWall_Request>();
}
...
static const _DeleteWall_Response_type_support_symbol_names_t _DeleteWall_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, virtual_wall_ros2, srv, DeleteWall_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, virtual_wall_ros2, srv, DeleteWall_Response)),
  }
};
...
{
  return &::virtual_wall_ros2::srv::rosidl_typesupport_cpp::DeleteWall_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, virtual_wall_ros2, srv, DeleteWall_Response)() {
  return get_message_type_support_handle<virtual_wall_ros2::srv::DeleteWall_Response>();
}
...
static const _DeleteWall_type_support_symbol_names_t _DeleteWall_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, virtual_wall_ros2, srv, DeleteWall)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, virtual_wall_ros2, srv, DeleteWall)),
  }
};
...
{
  return &::virtual_wall_ros2::srv::rosidl_typesupport_cpp::DeleteWall_service_type_support_handle;
}
