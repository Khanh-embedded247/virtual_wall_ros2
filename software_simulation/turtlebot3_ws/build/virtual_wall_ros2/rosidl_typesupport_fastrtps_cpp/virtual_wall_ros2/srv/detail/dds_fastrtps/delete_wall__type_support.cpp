...
#include "virtual_wall_ros2/srv/detail/delete_wall__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const virtual_wall_ros2::srv::DeleteWall_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  virtual_wall_ros2::srv::DeleteWall_Request & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = virtual_wall_ros2::srv::DeleteWall_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const virtual_wall_ros2::srv::DeleteWall_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<virtual_wall_ros2::srv::DeleteWall_Request *>(
    untyped_ros_message);
...
{
  return &virtual_wall_ros2::srv::typesupport_fastrtps_cpp::_DeleteWall_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, virtual_wall_ros2, srv, DeleteWall_Request)() {
  return &virtual_wall_ros2::srv::typesupport_fastrtps_cpp::_DeleteWall_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_virtual_wall_ros2
cdr_serialize(
  const virtual_wall_ros2::srv::DeleteWall_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  virtual_wall_ros2::srv::DeleteWall_Response & ros_message)
{
  // Member: status
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = virtual_wall_ros2::srv::DeleteWall_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const virtual_wall_ros2::srv::DeleteWall_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<virtual_wall_ros2::srv::DeleteWall_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &virtual_wall_ros2::srv::typesupport_fastrtps_cpp::_DeleteWall_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, virtual_wall_ros2, srv, DeleteWall_Response)() {
  return &virtual_wall_ros2::srv::typesupport_fastrtps_cpp::_DeleteWall_Response__handle;
}
...
{
  return &virtual_wall_ros2::srv::typesupport_fastrtps_cpp::_DeleteWall__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, virtual_wall_ros2, srv, DeleteWall)() {
  return &virtual_wall_ros2::srv::typesupport_fastrtps_cpp::_DeleteWall__handle;
}
