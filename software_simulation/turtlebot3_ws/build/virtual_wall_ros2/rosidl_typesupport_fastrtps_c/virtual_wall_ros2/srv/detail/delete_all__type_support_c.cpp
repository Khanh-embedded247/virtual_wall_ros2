...
#include "virtual_wall_ros2/srv/detail/delete_all__rosidl_typesupport_fastrtps_c.h"
...
using _DeleteAll_Request__ros_msg_type = virtual_wall_ros2__srv__DeleteAll_Request;
...
size_t get_serialized_size_virtual_wall_ros2__srv__DeleteAll_Request(
  const void * untyped_ros_message,
...
static uint32_t _DeleteAll_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_virtual_wall_ros2__srv__DeleteAll_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_virtual_wall_ros2
size_t max_serialized_size_virtual_wall_ros2__srv__DeleteAll_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = virtual_wall_ros2__srv__DeleteAll_Request;
    is_plain =
      (
...
static size_t _DeleteAll_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_virtual_wall_ros2__srv__DeleteAll_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, virtual_wall_ros2, srv, DeleteAll_Request)() {
...
using _DeleteAll_Response__ros_msg_type = virtual_wall_ros2__srv__DeleteAll_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_virtual_wall_ros2
size_t get_serialized_size_virtual_wall_ros2__srv__DeleteAll_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DeleteAll_Response__ros_msg_type * ros_message = static_cast<const _DeleteAll_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_virtual_wall_ros2__srv__DeleteAll_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_virtual_wall_ros2
size_t max_serialized_size_virtual_wall_ros2__srv__DeleteAll_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = virtual_wall_ros2__srv__DeleteAll_Response;
    is_plain =
      (
...
static size_t _DeleteAll_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_virtual_wall_ros2__srv__DeleteAll_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, virtual_wall_ros2, srv, DeleteAll_Response)() {
...
// already included above
// #include "virtual_wall_ros2/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "virtual_wall_ros2/srv/delete_all.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, virtual_wall_ros2, srv, DeleteAll)() {
