...
#include "virtual_wall_ros2/srv/detail/create_wall__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_virtual_wall_ros2
...
using _CreateWall_Request__ros_msg_type = virtual_wall_ros2__srv__CreateWall_Request;
...
size_t get_serialized_size_virtual_wall_ros2__srv__CreateWall_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CreateWall_Request__ros_msg_type * ros_message = static_cast<const _CreateWall_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CreateWall_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_virtual_wall_ros2__srv__CreateWall_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_virtual_wall_ros2
size_t max_serialized_size_virtual_wall_ros2__srv__CreateWall_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = virtual_wall_ros2__srv__CreateWall_Request;
    is_plain =
      (
...
static size_t _CreateWall_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_virtual_wall_ros2__srv__CreateWall_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, virtual_wall_ros2, srv, CreateWall_Request)() {
...
using _CreateWall_Response__ros_msg_type = virtual_wall_ros2__srv__CreateWall_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_virtual_wall_ros2
size_t get_serialized_size_virtual_wall_ros2__srv__CreateWall_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CreateWall_Response__ros_msg_type * ros_message = static_cast<const _CreateWall_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_virtual_wall_ros2__srv__CreateWall_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_virtual_wall_ros2
size_t max_serialized_size_virtual_wall_ros2__srv__CreateWall_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = virtual_wall_ros2__srv__CreateWall_Response;
    is_plain =
      (
...
static size_t _CreateWall_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_virtual_wall_ros2__srv__CreateWall_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, virtual_wall_ros2, srv, CreateWall_Response)() {
...
// already included above
// #include "virtual_wall_ros2/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "virtual_wall_ros2/srv/create_wall.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, virtual_wall_ros2, srv, CreateWall)() {
