...
#include "virtual_wall/srv/detail/create_wall__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = virtual_wall::srv::CreateWall_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const virtual_wall::srv::CreateWall_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<virtual_wall::srv::CreateWall_Request *>(
    untyped_ros_message);
...
{
  return &virtual_wall::srv::typesupport_fastrtps_cpp::_CreateWall_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = virtual_wall::srv::CreateWall_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const virtual_wall::srv::CreateWall_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<virtual_wall::srv::CreateWall_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &virtual_wall::srv::typesupport_fastrtps_cpp::_CreateWall_Response__handle;
}
...
{
  return &virtual_wall::srv::typesupport_fastrtps_cpp::_CreateWall__handle;
}
