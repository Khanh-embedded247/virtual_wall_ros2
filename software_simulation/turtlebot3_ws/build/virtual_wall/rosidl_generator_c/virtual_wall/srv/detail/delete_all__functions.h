...
#ifndef VIRTUAL_WALL__SRV__DETAIL__DELETE_ALL__FUNCTIONS_H_
#define VIRTUAL_WALL__SRV__DETAIL__DELETE_ALL__FUNCTIONS_H_
 ...
 * calls
 * virtual_wall__srv__DeleteAll_Request__init().
...
/**
 * It calls
 * virtual_wall__srv__DeleteAll_Request__fini()
 ...
 * virtual_wall__srv__DeleteAll_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * virtual_wall__srv__DeleteAll_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * virtual_wall__srv__DeleteAll_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_virtual_wall
...
/**
 * It calls
 * virtual_wall__srv__DeleteAll_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_virtual_wall
...
/**
 * It allocates the memory for the array and calls
 * virtual_wall__srv__DeleteAll_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_virtual_wall
...
/**
 * It calls
 * virtual_wall__srv__DeleteAll_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VIRTUAL_WALL__SRV__DETAIL__DELETE_ALL__FUNCTIONS_H_
