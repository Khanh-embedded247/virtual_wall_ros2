...
static const _DeleteWall_Request_type_support_symbol_names_t _DeleteWall_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, virtual_wall, srv, DeleteWall_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, virtual_wall, srv, DeleteWall_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, virtual_wall, srv, DeleteWall_Request)() {
  return &::virtual_wall::srv::rosidl_typesupport_c::DeleteWall_Request_message_type_support_handle;
}
...
static const _DeleteWall_Response_type_support_symbol_names_t _DeleteWall_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, virtual_wall, srv, DeleteWall_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, virtual_wall, srv, DeleteWall_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, virtual_wall, srv, DeleteWall_Response)() {
  return &::virtual_wall::srv::rosidl_typesupport_c::DeleteWall_Response_message_type_support_handle;
}
...
static const _DeleteWall_type_support_symbol_names_t _DeleteWall_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, virtual_wall, srv, DeleteWall)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, virtual_wall, srv, DeleteWall)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, virtual_wall, srv, DeleteWall)() {
  return &::virtual_wall::srv::rosidl_typesupport_c::DeleteWall_service_type_support_handle;
}
