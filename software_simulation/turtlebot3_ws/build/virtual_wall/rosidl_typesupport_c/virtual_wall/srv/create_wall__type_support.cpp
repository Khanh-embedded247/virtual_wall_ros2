...
static const _CreateWall_Request_type_support_symbol_names_t _CreateWall_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, virtual_wall, srv, CreateWall_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, virtual_wall, srv, CreateWall_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, virtual_wall, srv, CreateWall_Request)() {
  return &::virtual_wall::srv::rosidl_typesupport_c::CreateWall_Request_message_type_support_handle;
}
...
static const _CreateWall_Response_type_support_symbol_names_t _CreateWall_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, virtual_wall, srv, CreateWall_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, virtual_wall, srv, CreateWall_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, virtual_wall, srv, CreateWall_Response)() {
  return &::virtual_wall::srv::rosidl_typesupport_c::CreateWall_Response_message_type_support_handle;
}
...
static const _CreateWall_type_support_symbol_names_t _CreateWall_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, virtual_wall, srv, CreateWall)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, virtual_wall, srv, CreateWall)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, virtual_wall, srv, CreateWall)() {
  return &::virtual_wall::srv::rosidl_typesupport_c::CreateWall_service_type_support_handle;
}
